...
@Component({
  selector: 'app-text-attempt',
  templateUrl: './text-attempt.component.html',
  styleUrls: ['./text-attempt.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class TextAttemptComponent extends QuestionAnswerBaseComponent implements OnInit {

  constructor(private formAttemptSvc: FormAttemptService) {
    super();
   }

  @Input() item: TextElement;
